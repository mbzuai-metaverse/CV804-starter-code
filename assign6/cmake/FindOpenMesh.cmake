...
FIND_PATH(OPENMESH_INCLUDE_DIR OpenMesh/Core/Mesh/PolyMeshT.hh
	  PATHS /usr/local/include 
		    ...
		    "C:\\Program Files\\OpenMesh 8.1\\include"
                )
MESSAGE(${OPENMESH_INCLUDE_DIR})
...
FIND_LIBRARY(OPENMESH_CORE_DEBUG_LIBRARY NAMES OpenMeshCore PATHS ${SEARCH_PATHS})
FIND_LIBRARY(OPENMESH_TOOLS_DEBUG_LIBRARY NAMES OpenMeshTools PATHS ${SEARCH_PATHS})

FIND_LIBRARY(OPENMESH_CORE_LIBRARY NAMES OpenMeshCore PATHS ${SEARCH_PATHS})
FIND_LIBRARY(OPENMESH_TOOLS_LIBRARY NAMES OpenMeshTools PATHS ${SEARCH_PATHS})

INCLUDE (FindPackageHandleStandardArgs)

FIND_PACKAGE_HANDLE_STANDARD_ARGS(OpenMesh DEFAULT_MSG OPENMESH_CORE_LIBRARY OPENMESH_TOOLS_LIBRARY OPENMESH_INCLUDE_DIR OPENMESH_CORE_DEBUG_LIBRARY OPENMESH_TOOLS_DEBUG_LIBRARY)

IF (OPENMESH_FOUND)
    SET(OPENMESH_CORE_DEBUG_LIBRARY "${OPENMESH_CORE_DEBUG_LIBRARY}" )
    SET(OPENMESH_TOOLS_DEBUG_LIBRARY "${OPENMESH_TOOLS_DEBUG_LIBRARY}")
    SET(OPENMESH_INCLUDE_DIRS "${OPENMESH_INCLUDE_DIR}")
    SET(OPENMESH_CORE_LIBRARY "${OPENMESH_CORE_LIBRARY}")
    SET(OPENMESH_TOOLS_LIBRARY "${OPENMESH_TOOLS_LIBRARY}")
ENDIF (OPENMESH_FOUND)
