...
// Transform points
std::vector<Vector3d> Transformation::transformPoints( const std::vector< Vector3d > & ps ) {
...
// Transform vectors
std::vector<Vector3d> Transformation::transformVectors(const std::vector< Vector3d > & vs) {
